...
namespace AllAboutBooksWeb.Areas.Identity.Pages.Account;
...
public class RegisterModel : PageModel
{
    ...
    {
        var roleUserCustomerExists = await _roleManager.RoleExistsAsync(StaticDetails.RoleCustomer);

        if (!roleUserCustomerExists)
        {
